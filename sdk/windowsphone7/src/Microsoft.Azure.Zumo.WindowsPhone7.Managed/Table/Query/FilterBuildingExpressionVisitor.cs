...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    internal class FilterBuildingExpressionVisitor : ExpressionVisitor
    {
        ...
        /// expressions.
        /// 
        /// for wp7, Math.Floor/Math.Ceiling doesn't support decimal parameter, needs to use "decimal.Floor and decimal.Ceiling"
        /// </summary>
        private static Dictionary<MethodInfo, string> staticMethods =
            new Dictionary<MethodInfo, string>
            {
                ...
                { TypeExtensions.FindStaticMethod(typeof(decimal), "Floor", typeof(decimal)), floorFilterMethod },
                ...
                { TypeExtensions.FindStaticMethod(typeof(decimal), "Ceiling", typeof(decimal)), ceilingFilterMethod },
