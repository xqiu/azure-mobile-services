    ...
    internal static partial class TypeExtensions
    {
        ...
        public static IEnumerable<PropertyInfo> GetProperties(this Type type, bool inherit, bool publicOnly)
        {
            ...
            IEnumerable<PropertyInfo> properties =
                (inherit ?
                    ...
                    type.GetBaseTypesAndSelf().SelectMany(t => t.GetProperties(AllDeclared)) :
        ...
        public static IEnumerable<FieldInfo> GetFields(this Type type, bool inherit, bool publicOnly)
        {
            ...
            IEnumerable<FieldInfo> fields = inherit ?
                type.GetBaseTypesAndSelf().SelectMany(t => t.GetFields(AllDeclared)) :
        ...
        /// <summary>
        /// Gets a member attribute from a member.
        /// </summary>
        /// <typeparam name="T">The type of attribute.</typeparam>
        /// <param name="member">The member.</param>
        /// <param name="inherit">
        ...
        /// </param>
        /// <returns>
        /// A custom attribute for the member of type T, can be null.
        /// </returns>
            ...
            where T : Attribute
        {
            ...
            T[] attributes = (T[]) member.GetCustomAttributes(typeof(T), inherit);
        ...
        /// </param>
        /// <returns>
        /// All attributes for type of the type T, can be null.
        /// </returns>
        ...
        /// <summary>
        /// Gets attributes from a MethodInfo.
        /// </summary>
        /// <typeparam name="T">The type of attribute.</typeparam>
        /// <param name="member">The member.</param>
        /// <param name="inherit">
        ...
        /// </param>
        /// <returns>
        /// attributes for MethodInfo of the type T, can be null.
        /// </returns>
        public static T[] GetCustomAttributes<T>(this MethodInfo type, bool inherit = true)
            where T : Attribute
        {
            Debug.Assert(type != null, "type cannot be null!");
        ...
        public static Type GetUnderlyingType(this Type type)
        {
            ...
            return closedType != null ?
                closedType.GetGenericArguments()[0] :
                type;
        }
        ...
        private static Type GetIEnumerableClosedType(Type type)
        {
            ...
            {
                foreach (Type arg in info.GetGenericArguments())
                {
                    Type enumerableType = typeof(IEnumerable<>).MakeGenericType(arg);
                    if (enumerableType.IsAssignableFrom(info))
                    {
            ...
            foreach (Type interfaceType in info.GetInterfaces())
            {
